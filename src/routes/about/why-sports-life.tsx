    ...
    <>
      ...
      <Section>
        <SectionHeading
          ...
          title="Professional Facilities Across 3 Delhi Centres"
          body="Access to 25 professional courts with synthetic, clay, and grass surfaces for comprehensive athletic development."
        />
