    ...
    <div className="w-full bg-background min-h-screen">
      ...
      <Section id="key-insights" className="scroll-mt-36 bg-surface/30 border-b border-border/60">
        <div className="space-y-8">
          ...
          {/* Section Heading */}
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-black text-foreground">
            Sports Life Key Insights — Understanding the Reality
          </h2>

          {/* Intro paragraphs */}
          <div className="text-sm sm:text-base leading-relaxed text-foreground/85 max-w-4xl space-y-4">
            <p>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {/* Insight 1 — Trial Score Gap */}
            <div className="rounded-3xl border border-emerald-500/30 bg-emerald-500/5 p-7 space-y-4 shadow-sm hover:-translate-y-1 transition-all duration-300">
              <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400">
                <Trophy className="size-5" />
              ...
              <p className="text-sm text-foreground/85 leading-relaxed">
                From our analysis of the 2026 DU tennis trial results, we observed that the difference in trial scores between players who exited in the early rounds and players who progressed much further was <strong>not always as large as many candidates might expect.</strong>
              </p>
            </div>

            {/* Insight 2 — Certificate Impact */}
            <div className="rounded-3xl border border-amber-500/30 bg-amber-500/5 p-7 space-y-4 shadow-sm hover:-translate-y-1 transition-all duration-300">
              <div className="flex items-center gap-2 text-amber-600 dark:text-amber-400">
                <Award className="size-5" />
                <span className="text-xs font-black uppercase tracking-wider">Certificate Impact</span>
              </div>
              <h3 className="font-display text-xl font-black text-foreground">
                Certificates Can Make a Big Difference
              </h3>
              <p className="text-sm text-foreground/85 leading-relaxed">
                When we looked at the sports certificate component, we found that the difference in marks between different levels of achievement can be <strong>substantial.</strong> Your certificate category and the level of competition you have achieved can therefore create a significant difference in your overall CSM.
              </p>
            </div>

            {/* Insight 3 — CUET Matters */}
            <div className="rounded-3xl border border-blue-500/30 bg-blue-500/5 p-7 space-y-4 shadow-sm hover:-translate-y-1 transition-all duration-300">
              <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400">
                <GraduationCap className="size-5" />
                <span className="text-xs font-black uppercase tracking-wider">CUET Matters Too</span>
              </div>
              <h3 className="font-display text-xl font-black text-foreground">
                CUET Adds Further Weight
              </h3>
              <p className="text-sm text-foreground/85 leading-relaxed">
          ...
          {/* Reality Behind DU Sports Quota — Bold Statement + Summary */}
          <div className="relative overflow-hidden rounded-3xl border-2 border-neon/40 bg-linear-to-r from-neon/20 via-surface/95 to-neon/10 p-8 sm:p-14 text-center shadow-2xl">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-sm sm:text-base text-foreground/85 leading-relaxed">
              A player cannot afford to focus only on the trial and ignore the other components. Think of your DU Sports Quota profile as three parts:
            </p>
            <div className="mt-5 inline-flex flex-wrap items-center justify-center gap-3 rounded-2xl bg-surface/90 px-6 py-3 border border-border shadow-sm text-sm sm:text-lg font-black font-display text-foreground">
