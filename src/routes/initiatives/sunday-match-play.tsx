  ...
  return (
    <>
      ...
      <div className="relative">
        ...
        <div className="relative z-10 mx-auto -mt-7 max-w-7xl px-4 sm:-mt-10 sm:px-6 lg:px-8">
          <div className="flex flex-col items-start justify-between gap-4 rounded-2xl border border-neon/30 bg-surface/90 p-5 shadow-xl backdrop-blur-md sm:flex-row sm:items-center sm:p-6">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.18em] text-neon">
                Join the next session
              </p>
              <p className="mt-1 text-sm text-foreground/80">
                Register your interest for Sunday Match Play.
              </p>
            </div>
            <a
              ...
              className="inline-flex w-full shrink-0 items-center justify-center gap-2 rounded-full bg-neon px-6 py-3 font-display text-xs font-extrabold uppercase tracking-[0.14em] text-black transition-all hover:-translate-y-0.5 hover:bg-neon/90 hover:shadow-lg sm:w-auto"
            >
              Register Now
