  ...
  head: () => ({
    meta: [
      { title: "Meet Our Team — Certified Coaching Faculty | Sports Life Tennis Academy" },
      {
        name: "description",
        content:
          "Meet the coaching team at Sports Life Tennis Academy: 18+ coaches, international experience in Spain, NIS/PTR/AITA-ITF certifications across Delhi.",
      },
      { property: "og:title", content: "Meet Our Team — Sports Life Tennis Academy" },
      {
        property: "og:description",
        content:
          "18+ Coaches dedicated to structured player-first athlete development across 25 courts in Delhi.",
      },
            ...
            {otherCoaches.map((coach, i) => (
              <Reveal key={coach.name} delay={i * 0.02}>
                <article className="card-elevated group overflow-hidden rounded-2xl border border-border/80 bg-surface p-4 text-center shadow-xs transition-all hover:border-neon/50 hover:shadow-lg">
                  ...
                  <p className="mt-1 text-[11px] text-muted-foreground font-medium line-clamp-2">
                    {coach.bio}
                  </p>
                </article>
              </Reveal>
