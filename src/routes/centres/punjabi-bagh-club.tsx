  ...
  head: () => ({
    meta: [
      { title: "Punjabi Bagh Club — 10 Courts (6 Clay & 4 Synthetic) | Sports Life" },
      {
        name: "description",
        content:
          "Sports Life Tennis Academy at Punjabi Bagh Club, West Delhi. 6 Professional Clay Courts and 4 Synthetic Courts.",
      },
    ...
    <>
      ...
      <Section className="bg-surface/30">
        <SectionHeading
          ...
          title="10 Professional Courts for Complete Development"
          body="Punjabi Bagh Club features 6 professional clay courts and 4 synthetic courts, offering players the opportunity to train on multiple surfaces."
        />

        <div className="mt-10 grid gap-6 md:grid-cols-2">
          <div className="card-elevated rounded-2xl border border-border bg-surface p-7 shadow-md">
            <div className="mb-4 text-2xl">🎾</div>
            <h3 className="text-xl font-bold text-foreground">6 Professional Clay Courts</h3>
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              With six professionally maintained clay courts, players develop superior movement, sliding, endurance, tactical awareness and point construction. Clay court training encourages patience, consistency and strategic thinking.
            </p>
          </div>
